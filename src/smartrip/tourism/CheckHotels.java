...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run() {
      ...
      String[] text = new String[] {"Chanakya BNR Hotel" ,"Ginger Jamshedpur" ,"Grand Mirage Dhanbad","Hotel Mapel Wood", "Novanta Jamshedpur","Radisson Blue Hotel" ,"Ramada Jamshedpur", "The Kennelite Hotel", "The Alcor Hotel Jameshedpur", "Vivanta Jamshedpur Hotel", }; 
