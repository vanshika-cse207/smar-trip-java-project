...
public class DeleteDetails extends JFrame implements ActionListener {
    ...
    DeleteDetails(String username) {
        ...
        delete.setBackground(new Color(34, 139, 34));
        ...
        image.setBounds(20, 400, 450, 200); add(image);
        
        
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icon/viewcustomer.jpg")); 
        Image i5 = i4.getImage().getScaledInstance(500, 200, Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5); 
        JLabel image2 = new JLabel(i6); 
        image2.setBounds(450, 400, 500, 200); 
        add(image2);
