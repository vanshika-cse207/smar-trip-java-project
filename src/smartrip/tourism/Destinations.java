...
public class Destinations extends JFrame implements Runnable{
    ...
    public void run() {
      ...
      String[] text = new String[] {"Bhuvaneshwari Temple" ,"Dalma Wild Sanctuary" ,"Dassan Falls","Jagannath Temple", "Jonha Falls","Maithan Dam" ,"Netarhat(Queen Of Chotanagpur)", "Parasnath Hills", "Patratu Valley", "Rock Garden", }; 
